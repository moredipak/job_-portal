    ...
    <div class="container dashboard-content my-3">
      ...
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="applicationNameVersion" class="form-label"
            >Position Name</label
          >
          <input type="text" class="form-control" id="applicationNameVersion" placeholder="Position Name"/>
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="companyName" class="form-label">Available Positions</label>
          <input type="text" class="form-control" id="companyName" placeholder="Available Positions" />
        </div>
      </div>
      ...
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          ...
          <input type="text" class="form-control" id="tagLine" placeholder="Created On" />
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="logoPath" class="form-label">Caption Text</label>
          <input type="text" class="form-control" id="logoPath" placeholder="Caption Text"/>
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="mobileNo" class="form-label">Caption Sub-text</label>
          <input type="text" class="form-control" id="mobileNo" placeholder="Caption Sub-text"/>
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="email" class="form-label">Requirements</label>
          <input type="text" class="form-control" id="email" placeholder="Requirements" />
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="website" class="form-label">Bottom Text</label>
          <input type="text" class="form-control" id="website" placeholder="Bottom Text"/>
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="website" class="form-label">Status</label>
          <input type="text" class="form-control" id="website" placeholder="Status" />
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="website" class="form-label">Attachment File</label>
          <input type="text" class="form-control" id="website" placeholder="Attachment"/>
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="website" class="form-label">Interested Process</label>
          <input type="text" class="form-select" id="website" placeholder="Interested Process"/>
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="website" class="form-label">Technology</label>
          <input type="text" class="form-select" id="website" placeholder="Technology"/>
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="website" class="form-label">Candidate Type</label>
          <input type="text" class="form-select" id="website" placeholder="Candidate Type"/>
        </div>
      </div>
      <div class="row mb-3">
