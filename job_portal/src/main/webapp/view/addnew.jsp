            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <a class="dropdown-item" href="vacancy-list.html"
                      >Job Post / Program</a
                    >
                  </li>
                  <li>
                    <a class="dropdown-item" href="loginac.html"
                      >Login Activity</a
                    >
                  </li>
                </ul>
    ...
    <div class="container dashboard-content my-3">
      ...
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="applicationNameVersion" class="form-label"
            >Section Name</label
          >
          <input type="text" class="form-control" id="applicationNameVersion" placeholder="Section Name" />
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="companyName" class="form-label">Description</label>
          <input type="text" class="form-control" id="companyName" placeholder="Description"/>
        </div>
      </div>
      ...
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          ...
          <input type="text" class="form-control" id="tagLine" placeholder="23/06/2023 12:23:41 PM" disabled aria-placeholder="Created On" />
        </div>
      </div>
      <div class="row mb-3">
