    ...
    <div class="container dashboard-content my-3">
      ...
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="applicationNameVersion" class="form-label"
            >Section Name</label
          >
          <input type="text" class="form-select" id="applicationNameVersion"  placeholder="Section Name"/>
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="companyName" class="form-label">Content Name</label>
          <input type="text" class="form-control" id="companyName" placeholder="Content Name"/>
        </div>
      </div>
      ...
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          ...
          <input type="text" class="form-control" id="tagLine" placeholder="Description" />
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-8 mb-3 mx-auto">
          <label for="tagLine" class="form-label">Created On</label>
          <input type="text" class="form-control" id="tagLine1" placeholder="23/06/2023 12:23:41 PM" disabled aria-placeholder="Created On" />
        </div>
      </div>
