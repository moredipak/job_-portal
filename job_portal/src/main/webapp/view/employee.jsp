  ...
  <body>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="login-activity-list.html">Login Activity</a></li>
                </ul>
              </li>
            </ul>
            <form>
                <label for="form-control text-primary"> Welcome, Admin </label>
                <a href="adminlogin.html" class="text-primary text-decoration-none p-2 border text-center">Logout</a>  
    ...
    <div class="container dashboard-content text-center text-primary my-3">
      <div class="border-bottom mb-3 py-2 d-flex">
        <h4>Employee</h4>
        <a href="employeenew.html" class="text-primary text-decoration-none p-2 border text-center ms-auto">Add New</a>  
      </div>
